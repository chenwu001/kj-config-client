...
public class SxfConfigServicePropertySourceLocator implements PropertySourceLocator {
    ...
    private static final String SYS_PROPERTY_NAME = "sys";
    ...
    public org.springframework.core.env.PropertySource<?> locate(org.springframework.core.env.Environment environment) {
        ...
        if (null != applicationConfig && applicationConfig.getVersion() >= MIN_VERSION
            ...
            if(configClientProperties.isOverrideNone() && !configClientProperties.isOverrideSystemProperties()) {
                Properties properties = System.getProperties();
                Map<String, Object> source = applicationConfig.getSource();
                Set<String> stringPropertyNames = properties.stringPropertyNames();
                for(String str : stringPropertyNames) {
                    source.put(str, properties.get(str));
                }
                composite.addPropertySource(new MapPropertySource(SYS_PROPERTY_NAME, source));
            }
        }
        return composite;
    }
